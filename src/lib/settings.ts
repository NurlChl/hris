...
export const SETTING_DEFS: SettingDef[] = [
  ...
  /* ---- payroll ---- */
  { key: "payroll_late_penalty_per_minute", label: "Potongan keterlambatan", description: "Rupiah per menit keterlambatan.", type: "number", default: 0, unit: "Rp / menit", min: 0, max: 1000000, group: "payroll" },
  ...
  { key: "payroll_overtime_rate_per_hour", label: "Upah lembur", description: "Rupiah per jam lembur yang disetujui.", type: "number", default: 25000, unit: "Rp / jam", min: 0, group: "payroll" },

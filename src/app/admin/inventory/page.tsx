  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between border-b border-line pb-6">
        <div>
          <h1 className="text-xl font-semibold text-foreground dark:text-foreground flex items-center gap-2">
        ...
        <div className="flex gap-3">
          <button
            ...
            className="flex items-center gap-2 px-4 py-2 rounded-lg bg-success dark:bg-success text-xs font-semibold text-white cursor-pointer hover:bg-success transition-all border border-success"
          >
          ...
          <button
            ...
            className="flex items-center gap-2 px-4 py-2 rounded-lg bg-primary text-xs font-semibold text-primary-foreground cursor-pointer hover:bg-surface-2 dark:hover:bg-surface-2 transition-all border border-line-strong dark:border-white"
          >
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 bg-surface border border-line/60 dark:border-white/6 p-4 rounded-xl">
        <div>
          <label className="text-[11px] font-semibold text-foreground uppercase tracking-wider block mb-1.5">Cari Kode / Nama</label>
          <div className="relative">
            <input
              ...
              className="w-full pl-9 pr-4 py-2 rounded-lg bg-surface-2 border border-line text-foreground dark:text-foreground focus:outline-none focus:ring-1 focus:ring-primary dark:focus:ring-white text-xs placeholder:text-subtle"
            />
            <Search className="w-3.5 h-3.5 text-subtle absolute left-3 top-3" />
          </div>
        </div>
        <div>
          <label className="text-[11px] font-semibold text-foreground uppercase tracking-wider block mb-1.5">Saring Kategori</label>
          <select
            value={categoryFilter}
            onChange={(e) => setCategoryFilter(e.target.value)}
            className="w-full px-3 py-2 rounded-lg bg-surface-2 border border-line text-foreground dark:text-foreground focus:outline-none focus:ring-1 focus:ring-primary dark:focus:ring-white text-xs"
          >
                    ...
                    <td className="p-4">
                      {isAssigned ? (
                        <div className="space-y-1">
                          ...
                          <div className="flex flex-wrap items-center gap-1.5 text-[11px] uppercase font-semibold text-muted dark:text-muted">
          ...
          <div className="w-full max-w-lg h-full bg-surface border-l border-line relative z-10 shadow-[var(--shadow-pop)] p-6 flex flex-col justify-between overflow-y-auto">
            <div>
              <div className="flex items-center justify-between pb-4 border-b border-line mb-6">
                <h3 className="text-sm font-semibold text-foreground dark:text-foreground uppercase">
              ...
              {errorMsg && (
                <div className="mb-4 p-3 rounded bg-danger-soft border border-danger/20 text-danger text-xs flex items-center gap-2">
              ...
              {successMsg && (
                <div className="mb-4 p-3 rounded bg-success-soft border border-success/20 text-success text-xs flex items-center gap-2">
              ...
              <form onSubmit={handleSaveAsset} className="space-y-4 text-xs">
                <div>
                  <label className="block text-[11px] font-semibold text-foreground dark:text-muted uppercase tracking-wider mb-1.5">Kode Aset (Unique)</label>
                  <input
                    type="text"
                    required
                    value={formCode}
                    ...
                    className="w-full px-3 py-2 rounded-lg bg-surface-2 dark:bg-surface border border-line dark:border-line text-foreground dark:text-foreground focus:outline-none focus:ring-1 focus:ring-primary dark:focus:ring-white text-xs disabled:opacity-50"
                  />
                </div>
                <div>
                  <label className="block text-[11px] font-semibold text-foreground dark:text-muted uppercase tracking-wider mb-1.5">Nama Barang / Spesifikasi</label>
                  <input
                    type="text"
                    required
                    value={formName}
                    ...
                    className="w-full px-3 py-2 rounded-lg bg-surface-2 dark:bg-surface border border-line dark:border-line text-foreground dark:text-foreground focus:outline-none focus:ring-1 focus:ring-primary dark:focus:ring-white text-xs"
                  />
                </div>
                <div className="grid grid-cols-2 gap-4">
                  ...
                  <div>
                    <label className="block text-[11px] font-semibold text-foreground dark:text-muted uppercase tracking-wider mb-1.5">Kondisi Aset</label>
                    <select
                      value={formCondition}
            ...
            <div className="border-t border-line pt-4 mt-6 flex items-center justify-end gap-3">
              <button
                type="button"
                onClick={() => setIsFormOpen(false)}
                className="px-4 py-2 rounded-lg border border-line text-xs font-semibold text-foreground dark:text-muted hover:bg-surface-2 transition-all"
              >
                Batal
              </button>
              <button
                ...
                disabled={submitting}
                className="px-4 py-2 rounded-lg bg-primary text-xs font-semibold text-primary-foreground border border-line-strong dark:border-white hover:bg-surface-2 dark:hover:bg-surface-2 transition-all flex items-center gap-1.5 disabled:opacity-50"
              >
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/60 backdrop-blur-xs p-4">
          <div className="w-full max-w-md bg-surface border border-line rounded-xl shadow-[var(--shadow-pop)] p-6 flex flex-col">
            <div className="flex justify-between items-center pb-4 border-b border-line">
              <h3 className="text-sm font-semibold text-foreground dark:text-foreground uppercase">Tugaskan Aset Inventaris</h3>
              <button
            ...
            <div className="py-4 space-y-4 text-xs">
              <div className="p-3 bg-surface-2 rounded-lg border border-line space-y-1">
                ...
                <div className="text-xs text-muted dark:text-muted">Kode: {selectedAsset.code} &bull; Kategori: {selectedAsset.category}</div>
              </div>

              {errorMsg && (
                <div className="p-3 rounded bg-danger-soft border border-danger/20 text-danger text-xs flex items-center gap-2">
                  <ShieldAlert className="w-4 h-4" />
                  <span>{errorMsg}</span>
                </div>
              )}
              ...
              {successMsg && (
                <div className="p-3 rounded bg-success-soft border border-success/20 text-success text-xs flex items-center gap-2">
                  <CheckCircle className="w-4 h-4" />
                  <span>{successMsg}</span>
                </div>
              )}
            ...
            <div className="border-t border-line pt-4 flex justify-end gap-3">
              ...
              <button
                ...
                className="px-4 py-2 rounded-lg bg-primary text-xs font-semibold text-primary-foreground border border-line-strong dark:border-white hover:bg-surface-2 dark:hover:bg-surface-2 transition-all flex items-center gap-1.5 disabled:opacity-50 cursor-pointer"
              >
                {submitting && <Loader2 className="w-3.5 h-3.5 animate-spin" />}
                Tugaskan Aset
              </button>
      ...
      {signatureModalUrl && (
        <div className="fixed inset-0 z-55 flex items-center justify-center bg-black/60 backdrop-blur-xs p-4">
          <div className="w-full max-w-sm bg-surface border border-line rounded-xl shadow-[var(--shadow-pop)] p-6 flex flex-col">
            <div className="flex justify-between items-center pb-4 border-b border-line">
              <h3 className="text-xs font-semibold text-foreground dark:text-foreground uppercase">Tanda Tangan Serah Terima (BAST)</h3>
              <button
            ...
            <button
              onClick={() => setSignatureModalUrl(null)}
              className="w-full py-2 rounded-lg border border-line text-xs font-semibold text-foreground dark:text-muted hover:bg-surface-2 cursor-pointer transition-all"
            >
              Tutup
            </button>
          </div>
      ...
      {isAuditOpen && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/60 backdrop-blur-xs p-4 animate-fade-in">
          <div className="w-full max-w-md bg-surface border border-line rounded-xl shadow-[var(--shadow-pop)] p-6 flex flex-col gap-4">
            <div className="flex justify-between items-center pb-4 border-b border-line">
              <h3 className="text-sm font-semibold text-foreground dark:text-foreground uppercase">Audit Fisik Bulanan Inventaris</h3>
              <button
                onClick={() => {
                  setIsAuditOpen(false);
                  setAuditAsset(null);
            ...
            <form onSubmit={handleScanSearch} className="flex gap-2">
              <div className="flex-1 relative">
                <input
                  ...
                  className="w-full px-3 py-2 rounded-lg bg-surface-2 border border-line text-foreground dark:text-foreground focus:outline-none focus:ring-1 focus:ring-primary text-xs placeholder:text-subtle"
                />
              </div>
              <button
                type="submit"
                className="px-4 py-2 bg-primary text-xs font-semibold text-primary-foreground rounded-lg hover:bg-surface-2 dark:hover:bg-surface-2 transition-all border border-line cursor-pointer"
              >
                Temukan
              </button>
            </form>
            ...
            {!auditAsset && !successMsg && (
              <div className="relative border border-line rounded-lg overflow-hidden h-40 bg-surface-2 flex flex-col items-center justify-center text-white/60">
                ...
                <div className="border border-success/40 w-64 h-24 rounded flex items-center justify-center border-dashed relative">
                  ...
                  <span className="text-[11px] uppercase tracking-widest font-mono text-success">Menunggu Barcode...</span>
                </div>
                <span className="text-[11px] text-subtle mt-2 font-sans text-center px-4">Gunakan scanner barcode USB/wireless atau ketikkan kode di atas</span>
              </div>
            )}
            ...
            {auditAsset && (
              <form onSubmit={handleSaveAudit} className="space-y-4 text-xs">
                <div className="p-3 bg-surface-2 rounded-lg border border-line space-y-1.5">
                  ...
                  <div className="text-xs text-muted dark:text-muted">Kode: {auditAsset.code} &bull; Kategori: {auditAsset.category}</div>
                  <div className="text-xs text-muted dark:text-muted">Kondisi Saat Ini: <span className="capitalize font-semibold">{auditAsset.condition}</span></div>
                </div>

                <div>
                  <label className="block text-[11px] font-semibold text-foreground dark:text-muted uppercase tracking-wider mb-1.5">Kondisi Hasil Pemeriksaan</label>
                  <select
                    value={auditCondition}
                    onChange={(e) => setAuditCondition(e.target.value as "good" | "damaged" | "lost")}
                    className="w-full px-3 py-2 rounded-lg bg-surface-2 border border-line text-foreground dark:text-foreground focus:outline-none focus:ring-1 focus:ring-primary text-xs"
                  >
                    <option value="good">Baik</option>
                    <option value="damaged">Rusak</option>
                    <option value="lost">Hilang</option>
                ...
                <div>
                  <label className="block text-[11px] font-semibold text-foreground dark:text-muted uppercase tracking-wider mb-1.5">Catatan Pemeriksa (Auditor)</label>
                  <textarea
                    rows={3}
                    value={auditNotes}
                ...
                <div className="border-t border-line pt-4 flex gap-3 justify-end">
                  <button
                    ...
                    className="px-4 py-2 rounded-lg border border-line text-xs font-semibold text-foreground dark:text-muted hover:bg-surface-2 transition-all cursor-pointer"
                  >
                    Reset Pindai
                  </button>
                  <button
                    type="submit"
                    disabled={submitting}
                    className="px-4 py-2 bg-success hover:bg-success text-xs font-semibold text-white rounded-lg transition-all flex items-center gap-1.5 disabled:opacity-50 cursor-pointer"
                  >
                    {submitting && <Loader2 className="w-3.5 h-3.5 animate-spin" />}

...
export const POST = wrapRouteHandler(async (req) => {
  ...
  void notifyUsers(recipients, {
    ...
    refType: "complaint",
    refId: complaint._id as mongoose.Types.ObjectId,
  });
...
export const PATCH = wrapRouteHandler(async (req) => {
  ...
  if (body.message) {
    complaint.responses.push({
      userId: ctx.user.id as unknown as mongoose.Types.ObjectId,
  ...
  complaint.handledBy = ctx.user.id as unknown as mongoose.Types.ObjectId;

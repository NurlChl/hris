...
export function FaceEnrollment() {
  ...
  const submit = async () => {
    ...
    try {
      ...
      toast.success(isReplacement ? "Permintaan dikirim" : "Wajah terdaftar", res.message ?? "");
      abortCapture();
      await load();
    } catch (err) {
            ...
            <div className="text-center py-6 space-y-4">
              ...
              <div className="max-w-md mx-auto space-y-1.5">
                ...
                <p className="text-body-sm text-muted leading-relaxed">
                  Pendaftaran pertama langsung berlaku tanpa persetujuan. Setelah terdaftar, penggantian
